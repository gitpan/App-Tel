# This Makefile is for the App::Tel extension to perl.
#
...
#     NAME => q[App::Tel]
#     NO_META => q[1]
#     PREREQ_PM => { Expect=>q[0.0], Test::Most=>q[0.33], Hash::Merge::Simple=>q[0.0], ExtUtils::MakeMaker=>q[6.59] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.2002]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/rdrake/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/rdrake/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
